...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/HaisamAbbas',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/haisam-abbas-24a989202?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Email',
      url: 'mailto:HaisamAbbas@outlook.com',
      icon: (
          ...
          <div className="footer__section">
            ...
            <div className="footer__contact">
              <p className="footer__contact-item">
                ...
                <a href="mailto:HaisamAbbas@outlook.com" className="footer__contact-link">
                  HaisamAbbas@outlook.com
                </a>
              </p>
              <p className="footer__contact-item">

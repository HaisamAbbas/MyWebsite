        ...
        <div className="hero__content">
          <div className="hero__text">
            <h1 className="hero__title animate-fade-in-up">
              ...
              <span className="hero__name animate-fade-in-up animate-delay-300">Haisam Abbas</span>
            ...
            <p className="hero__description animate-fade-in-up animate-delay-700">
              I love <strong>building AI systems from the ground up</strong>, exploring the nuts and bolts of LLMs, Agents, and Mechanistic Interpretability.  
          ...
          <div className="hero__actions animate-fade-in-up animate-delay-1000">
            ...
            <a 
              href={`${import.meta.env.BASE_URL}Haisam-Abbas-Resume-AI-Engineer.pdf`} 
              download 
